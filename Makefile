...
## Run pre-flight security check before GitHub publication
preflight:
	@echo "Running pre-flight security check..."
	$(PYTHON_SYS) scripts/github_01_preflight_check.py
...
help:
	...
	@echo "  make preflight         - Run pre-flight security check"
	@echo ""
