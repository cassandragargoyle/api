...
- Do not add "Generated with [Claude Code]" signatures to code or files See docs/contributing/CODE-STYLE-*.md for language-specific guidelines
...
git clone https://github.com/cassandragargoyle/api.git
cd api
