...
This issue is a design rationale for sharing code across products via a
versioned Maven artifact on GitHub Packages, rather than copying the API
module between repositories. It carries no executable acceptance
criteria of its own.
